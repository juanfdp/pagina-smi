...
<p><span class="NumOn">2</span>Comparar</p>
</div>
<div id="magicStep" class="off">
...
<input type="text" name="dateExit" id="f_dateExit" class="dateImg"
	value="<?php echo $regreso; ?>" /> <!-- ENDS CHOOSE COUNTRIES -->
</div>
...
<input type="text" name="f_oldsNums1" id="f_oldsNums1" size="1"
	...
	name="f_oldsNums2" id="f_oldsNums2" size="1" style="width: 20px;"
	maxlength="2" value="<?php echo $edad2; ?>"
	onkeypress="return acceptNum(event)" /> <input type="text"
	name="f_oldsNums3" id="f_oldsNums3" size="1" style="width: 20px;"
	maxlength="2" value="<?php echo $edad3; ?>"
	onkeypress="return acceptNum(event)" /> <input type="text"
	name="f_oldsNums4" id="f_oldsNums4" size="1" style="width: 20px;"
	maxlength="2" value="<?php echo $edad4;?>"
	onkeypress="return acceptNum(event)" /> <!--ENDS TRAVEL INFO--></div>
<div id="chooseTarget" class="fourStep"><!--EMAIL FORM HERE INFO--> <label>Email:</label><br />
<input type="text" name="email" id="f_email" size="18"
	value="<?php echo $email; ?>" /> <br />
<br />
 <a class="contactenos" id="lightbox" href="logic/compare.php?tipo=2">COMPARAR</a>
</div>
...
<div class="rightMagicBox"><!--HERE THE SUBMIT TYPE & OTHERS VARS--> <input
	...
	src="tpl/img/clear.png" class="submitQuote"  id="Cotizar" value="Cotizar" /></div>
...
<div id="temp"></div>
<div id="magicResult"><!--- START HERE THE QUOTE RESULT ---> <!--START HERE A FOR-WHILE --->
...
<ul>";		
		...
		//RECORREMOS E IMPRIMIMOS LAS COBERTURAS
...
?> <!--ENDS FOR-WHILE BUCLE---></div>
<!--- ENDS THE QUOTE RESULT ---></div>
