...
WHERE        			((Productos.IdTipoRango = 2 AND  '. $dias .' BETWEEN Productos.DiasIniciales AND Productos.DiasFinales OR
	...
	public function Getclausulado($idAseguradora)
	{
		try
		{
			...
			switch (strtolower($idAseguradora) ) {
				case "169159ad-d55a-467b-9efd-2b7139ecc730": //ANDI ASISTENCIA SA
					return "<a href=\"javascript:cargarClausulado('clausulados/SEGURVIAJE_MAPFRE ASISTENCIA.pdf',800,500)\" class=\"chooseClausu\">Ver Clausulado</a>";

					break;
				case "ae7c4aa0-bcba-4804-b2aa-3496c4edc5f7": // CORIS SA
					return "<a  href=\"javascript:compararPolizas('clausulados/CORIS.pdf',800,500)\"  class=\"chooseClausu\" >Ver Clausulado</a>";

					break;
				case "715697a2-f643-4d5b-ac49-83b11e8546b0": // UNIVERSAL

					return "<a  href=\"javascript:cargarClausulado('clausulados/UNIVERSAL_ASSISTANCE.pdf',800,500)\"  class=\"chooseClausu\" >Ver Clausulado</a>";

					break;
				case "b2ff47cf-50d3-4803-992d-9ee57d9fe736": // EDUCAMOS VIAJANDO LTDA()SAFEST

					return "<a  href=\"javascript:cargarClausulado('clausulados/SAFEST.pdf',800,500)\"  class=\"chooseClausu\" >Ver Clausulado</a>";

					break;
				case "4e04d2c4-5c91-46e4-99dd-e992638da6f8": // ASSIST CARD

					return "<a   href=\"javascript:cargarClausulado('clausulados/ASSIST_CARD.pdf',800,500)\"  class=\"chooseClausu\"  >Ver Clausulado</a>";

					break;
				case "8528cc83-53f7-4330-aaed-ef0a5ad2b08f": // CHARTIS COLOMBIA SEGUROS GENERALES SA


					return "<a  href=\"javascript:cargarClausulado('clausulados/CHARTIS.pdf',800,500)\"  class=\"chooseClausu\" >Ver Clausulado</a>";

					break;
				case "db7a54c0-bf90-4508-9528-f7c6af83357b": // QUALITAS ASSISTANCE SAS

					return "<a  href=\"javascript:cargarClausulado('clausulados/QUALITAS_ASSISTANCE.pdf',800,500)\"  class=\"chooseClausu\"  >Ver Clausulado</a>";
