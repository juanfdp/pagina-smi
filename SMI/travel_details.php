...
<!-- the "no-js" class is for Modernizr. --><head id="www-segurosmedicosinternacionales-com" data-template-set="html5-reset">
	...
	<meta name="Copyright" content="Copyright √É‚Äö√Ç¬© 2011 Seguros Medicos Internacionales All Rights Reserved">
...
$descripcion = "Pago de p√É¬≥liza: ".$_POST['NombreFactu'] ;
...
//You should create the validator only after the definition of the HTML form
  ...
  if(cantidadPasajeros==1){
	  ...
	  frmvalidator.addValidation("fndia1","dontselect=0","Debe Ingresar El DÌa De Nacimiento-Pasajero 1.");
	  frmvalidator.addValidation("fnmes1","dontselect=0","Debe Ingresar El Mes De Nacimiento-Pasajero 1.");
	  frmvalidator.addValidation("fnanio1","dontselect=0","Debe Ingresar El AÒo De Nacimiento-Pasajero 1.");
	    }
  else if(cantidadPasajeros==2){
	...
	//PASAJERO2
	  ...
	  frmvalidator.addValidation("fndia2","dontselect=0","Debe Ingresar El DÌa De Nacimiento-Pasajero 2.");
	  frmvalidator.addValidation("fnmes2","dontselect=0","Debe Ingresar El Mes De Nacimiento-Pasajero 2.");
	  frmvalidator.addValidation("fnanio2","dontselect=0","Debe Ingresar El AÒo De Nacimiento-Pasajero 2.");
  }
  else if(cantidadPasajeros==3){
	...
	//PASAJERO3
	  ...
	  frmvalidator.addValidation("fndia3","dontselect=0","Debe Ingresar El DÌa De Nacimiento-Pasajero 3.");
	  frmvalidator.addValidation("fnmes3","dontselect=0","Debe Ingresar El Mes De Nacimiento-Pasajero 3.");
	  frmvalidator.addValidation("fnanio3","dontselect=0","Debe Ingresar El AÒo De Nacimiento-Pasajero 3.");
	...
	//PASAJERO4
	  ...
	  frmvalidator.addValidation("fndia4","dontselect=0","Debe Ingresar El DÌa De Nacimiento-Pasajero 4.");
	  frmvalidator.addValidation("fnmes4","dontselect=0","Debe Ingresar El Mes De Nacimiento-Pasajero 4.");
	  frmvalidator.addValidation("fnanio4","dontselect=0","Debe Ingresar El AÒo De Nacimiento-Pasajero 4.");
  }
  //CONTACTO VIAJEROS
  frmvalidator.addValidation("TelefonoContacto","req","Debe Ingresar Un TelÈfono-Contacto.");
  frmvalidator.addValidation("CelularContacto","req","Debe Ingresar Un TelÈfono Movil-Contacto."); 
  frmvalidator.addValidation("DireccionContacto","req","Debe Ingresar Una DirecciÛn-Contacto.");
  //CONTACTO EMERGENCIA
  ...
  frmvalidator.addValidation("TelefonoEmergencia","req","Debe Ingresar El TÈlefono-Contacto Emergencia.");
  ...
  //FACTURACION
  frmvalidator.addValidation("descripcion","req","Debe Ingresar El Nombre/Entidad-FacturaciÛn.");
  frmvalidator.addValidation("DocumentoFactu","req","Debe Ingresar El Documento/Nit-FacturaciÛn."); 
  frmvalidator.addValidation("DireccionFactu","req","Debe Ingresar La DirecciÛn-FacturaciÛn.");
  frmvalidator.addValidation("TelefonoFactu","req","Debe Ingresar El TelÈfono-FacturaciÛn.");
  frmvalidator.addValidation("emailComprador","maxlen=50");
  frmvalidator.addValidation("emailComprador","req","Debe Ingresar Un E-mail-FacturaciÛn.");
  frmvalidator.addValidation("emailComprador","email","Debe Ingresar Un E-mail V·lido-FacturaciÛn."); 
